...
void l1validation()
{
  ...
  //   // single muon plots (pt resolution, eff vs eta/phi)
  ...
  // single electron plots (et resolution, eff vs eta/phi)
  ...
  //   // single pion plots (et resolution, eff vs eta/phi)
  //   TFile *f = new TFile("single_pi.root");
  //   TString dir = "";
  
  //   // make jet sum histograms
  

  //   f->close();
  
  //   // H -> 4 mu plots (turn on)
  //   TFile *f = new TFile("H_4mu.root");
  
  //   f->close();
  
  //   // H -> 2 gamma plots (turn on)
  //   TFile *f = new TFile("H_2gamma.root");
  
  //   f->close();
  
  //   // H -> 2 tau plots (turn on)
  //   TFile *f = new TFile("H_2tau.root");
  
  //   f->close();
  
  //   // Z' -> dijets plots (turn on)
